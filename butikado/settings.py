...
SECRET_KEY = 'django-insecure-d@atgequp@n+2drf9gv_jn98)17)0^-#hbxyuc6a=xu9xq&d-0'
...
STRIPE_CURRENCY = 'usd'
STRIPE_PUBLIC_KEY = os.getenv('STRIPE_PUBLIC_KEY', 'DefaultPublicKey')
STRIPE_SECRET_KEY = os.getenv('STRIPE_SECRET_KEY', 'DefaultSecretKey')
